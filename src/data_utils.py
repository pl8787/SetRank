...
class Raw_data:
    def __init__(self, data_path = None, file_prefix = None, with_dummy = False):
        if data_path == None:
            self.embed_size = -1
...
def read_data(data_path, file_prefix, with_dummy=False):
    data = Raw_data(data_path, file_prefix, with_dummy=with_dummy)
    return data
